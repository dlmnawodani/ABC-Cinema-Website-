...
<body>
        ...
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                ...
                <div class="d-inline-flex text-white">
                    ...
                    <p class="m-0 text-uppercase">Log-In</p>
                </div>
            </div>
        </div>
    </div>
    <!-- Header End -->
     ...
     <div class="row justify-content-center">
        <div class="col-lg-5">
                    <div class="card border-4"  style="margin: 150px 0px;"   >
                        <div class="card-header bg-primary text-center p-4">
                            <h1 class="text-white m-0">Log In Now</h1>
                        </div>
                        <div class="card-body rounded-bottom bg-white p-5">
                            ...
                            <form action="LoginServlet" method="POST">
                                ...
                                <div>
                                    ...
                                    <button class="btn btn-primary btn-block py-3 p-4" type="submit">Log-In</button>
                                     <button class="btn btn-primary btn-block py-3 p-4" type="reset">Clear</button>
