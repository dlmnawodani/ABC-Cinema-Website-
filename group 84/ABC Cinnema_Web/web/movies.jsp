    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Movies</h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        ...
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <a class="h5 text-decoration-none" href="">Resident Evil</a>
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Homagama<br><center>Sri Lanka</center></small>
                            </div>
                            <a href="tickets.jsp" class="btn btn-primary mt-1">Book Now</a>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        ...
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <a class="h5 text-decoration-none" href="">NFS Pro Street</a>
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Homagama<br><center>Sri Lanka</center></small>
                            </div>
                            <a href="tickets.jsp" class="btn btn-primary mt-1">Book Now</a>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        ...
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <a class="h5 text-decoration-none" href="">Revolution</a>
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Homagama<br><center>Sri Lanka</center></small>
                            </div>
                            <a href="tickets.jsp" class="btn btn-primary mt-1">Book Now</a>
